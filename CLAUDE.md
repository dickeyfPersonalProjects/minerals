...
**YOU ARE IN: `minerals/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/minerals/` (rig root) or other directories
...
**Your mail address:** `minerals/polecats/rust`
**Your rig:** minerals
**Your Witness:** `minerals/witness`
...
| Ask Witness for help | `gt mail send minerals/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`minerals/witness`) when:
...
```bash
gt mail send minerals/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
